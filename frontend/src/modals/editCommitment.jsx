  ...
  return (
    <div className="modal-container" ref={modal_ref}>
      <form onSubmit={handleSubmit} className="addCommitment-form">
        <h1 className="modal-title">Edit Commitment</h1>
        <div className="modal-group">
          ...
          <input
            ...
            name="name"
            id="name"
            value={activeCommitment.name}
            placeholder={activeCommitment.name}
            required
        ...
        <div className="modal-group">
          ...
          <textarea
            placeholder={activeCommitment.description}
            className="form-control"
            name="description"
            id="description"
            value={activeCommitment.description}
            required
        ...
        <div className="modal-group">
          ...
          <input
            ...
            name="pledge-amount"
            defaultValue={activeCommitment.moneyCommitted}
